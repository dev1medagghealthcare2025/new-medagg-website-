...
const DiabeticFootBangalore = () => {
  return (
    <>
      <PageMeta
        title='Diabetic Foot Treatment in Bangalore | Non-Surgical Limb Care'
        description='Get advanced non-surgical Diabetic Foot treatment in Bangalore. Endovascular recanalization & stenting by Interventional Radiology specialists at MEDAGG.'
      />
      <Navbar />
      <Treatmentnavbar />
      <DiabeticHeroSection city='Bangalore' variant='bangalore' />
      <WhyChooseDiabeticFoot />
      <HowWorkDiabetic />
      <AreYouExperiencingDiabetic />
      <DiabeticFootWhySurgeries city='Bangalore' variant='bangalore' />
      <BookAppointmentDiabetic city='Bangalore' variant='bangalore' />
      <CompareDiabetic />
      <WhatHappenDiabetic />
      <OurDoctor />
      <OurTestimonial />
      <Consultourdoctor city='Bangalore' variant='bangalore' />
      <DiabeticFootFaq city='Bangalore' variant='bangalore' />
    </>
  );
};

export default DiabeticFootBangalore;
