...
const UAE_mangalore = () => {
  return (
    <>
      <PageMeta
        title='No-Surgery Uterine Fibroid Treatment in Mangalore | Uterine Artery Embolization (UAE)'
        description='Advanced non-surgical uterine fibroid treatment in Mangalore with Uterine Artery Embolization (UAE). Consult IR specialists for uterus-preserving care.'
      />
      <Navbar />
      <Treatmentnavbar />
      <UAE_Herosection city='Mangalore' variant='mangalore' />
      <WhyChooseUAE />
      <HowUAEWorks />
      <AreYouExperiencingUAE />
      <UAEWhySurgeries city='Mangalore' variant='mangalore' />
      <ThinkYouMightNeedUAE city='Mangalore' variant='mangalore' />
      <UAE_Compare />
      <WhatHappenUAE
      ...
      <UaeFaq city='Mangalore' variant='mangalore' />
    </>
  );
};

export default UAE_mangalore;
