...
const Varicocele_embolization_delhi = () => (
  <>
    <PageMeta
      title='Best Specialists for Varicocele Embolization | Non-surgical Varicocele Treatment in Delhi'
      description='Seek expert non-surgical varicocele treatment in Delhi. Our embolization procedure offers quick recovery and solves infertility or pain issues.'
    />
    <Navbar />
    <Treatmentnavbar />
    <Varicocele_herosection city='Delhi' variant='delhi' />
    <WhyChooseVaricocele city='Delhi' variant='delhi' />
    <HowVaricoceleEmbolizationWork />
    <AreYouExperiencingVaricocele />
    <VaricoceleWhySurgeries city='Delhi' variant='delhi' />
    <BookAppointmentVaricocele city='Delhi' variant='delhi' />
    ...
    <VaricoceleFaq city='Delhi' variant='delhi' />
  </>
);

export default Varicocele_embolization_delhi;
