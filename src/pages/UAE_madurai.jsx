...
const UAE_madurai = () => {
  return (
    <>
      <PageMeta
        title='No-Surgery Uterine Fibroid Treatment in Madurai | Uterine Artery Embolization (UAE)'
        description='Advanced non-surgical uterine fibroid treatment in Madurai with Uterine Artery Embolization (UAE). Consult IR specialists for uterus-preserving care.'
      />
      <Navbar />
      <Treatmentnavbar />
      <UAE_Herosection city='Madurai' variant='madurai' />
      <WhyChooseUAE />
      <HowUAEWorks />
      <AreYouExperiencingUAE />
      <UAEWhySurgeries city='Madurai' variant='madurai' />
      <ThinkYouMightNeedUAE city='Madurai' variant='madurai' />
      <UAE_Compare />
      <WhatHappenUAE
      ...
      <UaeFaq city='Madurai' variant='madurai' />
    </>
  );
};

export default UAE_madurai;
