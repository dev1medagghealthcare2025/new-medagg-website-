...
const PVCMangalore = () => {
  return (
    <div className='bg-white'>
      <PageMeta
        title='Pelvic Vein Embolization in Mangalore | Minimally Invasive Relief for Chronic Pelvic Pain'
        description='Advanced non-surgical Pelvic Vein Embolization treatment in Mangalore. Minimally invasive relief for chronic pelvic pain caused by pelvic venous congestion.'
      />
      <Navbar />
      <Treatmentnavbar />
      <PVCHeroSection city='Mangalore' variant='mangalore' />
      <PVCWhyChooseNoSurgeries />
      <PVCHowItWorks />
      <PVCAreYouExperiencing />
      <PVCWhyChooseMedagg city='Mangalore' variant='mangalore' />
      <PVCBookAppointment city='Mangalore' variant='mangalore' />
      <PVCCompare />
      <OurDoctor />
      <OurTestimonial />
      <ConsultOurDoctor city='Mangalore' variant='mangalore' />
      <PVC_FAQ city='Mangalore' variant='mangalore' />
    </div>
  );
};

export default PVCMangalore;
