...
const VaricoseVeinBangalore = () => {
  return (
    <div className='bg-white'>
      <PageMeta
        title='No-Surgery Varicose Veins Treatment in Bangalore | Endovenous Ablation'
        description='Advanced non-surgical varicose veins treatment in Bangalore. Consult interventional radiology specialists for minimally invasive vein-preserving care.'
      />
      <Navbar />
      <Treatmentnavbar />
      <VaricoseVeinHeroSection city='Bangalore' variant='bangalore' />
      <WhyChooseEndovenousAblation />
      <VaricoseVeinWork />
      <AreYouExperiencingVaricocele />
      <VvWhySurgeries city='Bangalore' variant='bangalore' />
      <VV_BookAnAppointment city='Bangalore' variant='bangalore' />
      ...
      <VvFaq city='Bangalore' variant='bangalore' />
    </div>
  );
};

export default VaricoseVeinBangalore;
