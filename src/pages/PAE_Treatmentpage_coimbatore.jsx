...
const PAE_Treatmentpage_coimbatore = () => (
  <>
    <PageMeta
      title='Prostate Artery Embolization Non Surgical Treatment With PAE in Coimbatore'
      description='Effective BPH relief with Prostate Artery Embolization (PAE) in Coimbatore. A non-surgical, painless treatment for enlarged prostate. Book today!'
    />
    <Navbar />
    <Treatmentnavbar />
    <PAE_HeroSection city='Coimbatore' variant='coimbatore' />
    <PAE_Treatment_Why_Choose_Us />
    <PAE_Treatment_Procedure />
    <PAE_Treatment_FAQs />
    <PAEWhySurgeries city='Coimbatore' variant='coimbatore' />
    <PAE_Treatment_Testimonials city='Coimbatore' variant='coimbatore' />
    ...
    <PaeFaq city='Coimbatore' variant='coimbatore' />
  </>
);

export default PAE_Treatmentpage_coimbatore;
