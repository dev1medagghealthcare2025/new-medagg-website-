...
const FTE_coimbatore = () => {
  return (
    <>
      <PageMeta
        title='Fallopian Tube Recanalization (FTR) Treatment in Coimbatore | NoSurgeries'
        description='Advanced non-surgical Fallopian Tube Recanalization (FTR) in Coimbatore by Interventional Radiology specialists. Book a consultation with NoSurgeries by Medagg.'
      />
      <Navbar />
      <Treatmentnavbar />
      <FTE_HeroSection city='Coimbatore' variant='coimbatore' />
      <WhyChooseFTE />
      <HowFTEWork />
      <AreYouExperienceFTE />
      <FTEWhySurgeries city='Coimbatore' variant='coimbatore' />
      <BookAppointmentFTE city='Coimbatore' variant='coimbatore' />
      ...
      <FtrFaq city='Coimbatore' variant='coimbatore' />
    </>
  );
};

export default FTE_coimbatore;
