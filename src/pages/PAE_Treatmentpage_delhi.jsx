...
const PAE_Treatmentpage_delhi = () => (
  <>
    <PageMeta
      title='Prostate Artery Embolization Non Surgical Treatment With PAE in Delhi'
      description='Effective BPH relief with Prostate Artery Embolization (PAE) in Delhi. A non-surgical, painless treatment for enlarged prostate. Book today!'
    />
    <Navbar />
    <Treatmentnavbar />
    <PAE_HeroSection city='Delhi' variant='delhi' />
    <PAE_Treatment_Why_Choose_Us />
    <PAE_Treatment_Procedure />
    <PAE_Treatment_FAQs />
    <PAEWhySurgeries city='Delhi' variant='delhi' />
    <PAE_Treatment_Testimonials city='Delhi' variant='delhi' />
    ...
    <PaeFaq city='Delhi' variant='delhi' />
  </>
);

export default PAE_Treatmentpage_delhi;
