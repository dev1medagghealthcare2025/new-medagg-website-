...
const PAE_Treatmentpage_mangalore = () => (
  <>
    <PageMeta
      title='Prostate Artery Embolization Non Surgical Treatment With PAE in Mangalore'
      description='Effective BPH relief with Prostate Artery Embolization (PAE) in Mangalore. A non-surgical, painless treatment for enlarged prostate. Book today!'
    />
    <Navbar />
    <Treatmentnavbar />
    <PAE_HeroSection city='Mangalore' variant='mangalore' />
    <PAE_Treatment_Why_Choose_Us />
    <PAE_Treatment_Procedure />
    <PAE_Treatment_FAQs />
    <PAEWhySurgeries city='Mangalore' variant='mangalore' />
    <PAE_Treatment_Testimonials city='Mangalore' variant='mangalore' />
    ...
    <PaeFaq city='Mangalore' variant='mangalore' />
  </>
);

export default PAE_Treatmentpage_mangalore;
