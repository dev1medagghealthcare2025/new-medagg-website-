...
const Planter_chennai = () => {
  return (
    <>
      <PageMeta
        title='Plantar Fasciitis Treatment in Chennai | Non-Surgical Heel Pain Relief'
        description='Get advanced non-surgical Plantar Fasciitis treatment in Chennai. Plantar Fascial Embolization (PFE) by Interventional Radiology specialists for chronic heel pain relief.'
      />
      <Navbar />
      <Treatmentnavbar />
      <PlanterHeroSection city='Chennai' variant='chennai' />
      <WhyChoosePlantar />
      <HowPlantarWork />
      <AreYouExperiencingPlanter />
      <PlanterWhySurgeries city='Chennai' variant='chennai' />
      <BookappoinmentPlanter city='Chennai' variant='chennai' />
      <CompareTreatmentPlanter />
      {/* <WhatHappensInPlantar /> */}
      <OurDoctor />
      <OurTestimonial/>
      <Consultourdoctor city='Chennai' variant='chennai' />
      <PlantarFaq city='Chennai' variant='chennai' />
    </>
  );
};

export default Planter_chennai;
