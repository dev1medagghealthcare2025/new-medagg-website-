...
const GAE_Treatmentpage_delhi = () => (
  <>
    <PageMeta
      title='Genicular Artery Embolization Non Surgical Treatment With GAE in Delhi'
      description='Relieve chronic knee pain without surgery. Genicular Artery Embolization (GAE) in Delhi offers effective, non-invasive knee pain treatment. Book today!'
    />
    <Navbar />
    <Treatmentnavbar />
    <GAE_HeroSection city='Delhi' variant='delhi' />
    <GAE_Treatment_Why_Choose_us />
    <HowGAEWork />
    <GAE_Are_you_experience />
    <GAEWhySurgeries city='Delhi' variant='delhi' />
    <GAE_Bookanappoinment city='Delhi' variant='delhi' />
    ...
    <GaeFaq city='Delhi' variant='delhi' />
  </>
);

export default GAE_Treatmentpage_delhi;
