...
const Thyroid_Nodule_Ablation_Treatmentpage_madurai = () => (
  <>
    <PageMeta
      title='Thyroid Nodule Ablation Non Surgical Treatment in Madurai'
      description='Effective non-surgical thyroid nodule treatment in Madurai. Minimally invasive ablation procedure with quick recovery. Book today!'
    />
    <Navbar />
    <Treatmentnavbar />
    <ThyroidHerosection city='Madurai' variant='madurai' />
    <WhyChooseThyroid />
    <HowThyroidWork />
    <ThyroidWhySurgeries city='Madurai' variant='madurai' />
    <ThyroidBookAppointment city='Madurai' variant='madurai' />
    ...
    <ThyroidFaq city='Madurai' variant='madurai' />
  </>
);

export default Thyroid_Nodule_Ablation_Treatmentpage_madurai;
