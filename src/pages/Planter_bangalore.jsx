...
const Planter_bangalore = () => {
  return (
    <>
      <PageMeta
        title='Plantar Fasciitis Treatment in Bangalore | Non-Surgical Heel Pain Relief'
        description='Get advanced non-surgical Plantar Fasciitis treatment in Bangalore. Plantar Fascial Embolization (PFE) by Interventional Radiology specialists for chronic heel pain relief.'
      />
      <Navbar />
      <Treatmentnavbar />
      <PlanterHeroSection city='Bangalore' variant='bangalore' />
      <WhyChoosePlantar />
      <HowPlantarWork />
      <AreYouExperiencingPlanter />
      <PlanterWhySurgeries city='Bangalore' variant='bangalore' />
      <BookappoinmentPlanter city='Bangalore' variant='bangalore' />
      <CompareTreatmentPlanter />
      <OurDoctor />
      <OurTestimonial />
      <Consultourdoctor city='Bangalore' variant='bangalore' />
      <PlantarFaq city='Bangalore' variant='bangalore' />
    </>
  );
};

export default Planter_bangalore;
