...
const FTE_mangalore = () => {
  return (
    <>
      <PageMeta
        title='Fallopian Tube Recanalization (FTR) Treatment in Mangalore | NoSurgeries'
        description='Advanced non-surgical Fallopian Tube Recanalization (FTR) in Mangalore by Interventional Radiology specialists. Book a consultation with NoSurgeries by Medagg.'
      />
      <Navbar />
      <Treatmentnavbar />
      <FTE_HeroSection city='Mangalore' variant='mangalore' />
      <WhyChooseFTE />
      <HowFTEWork />
      <AreYouExperienceFTE />
      <FTEWhySurgeries city='Mangalore' variant='mangalore' />
      <BookAppointmentFTE city='Mangalore' variant='mangalore' />
      ...
      <FtrFaq city='Mangalore' variant='mangalore' />
    </>
  );
};

export default FTE_mangalore;
