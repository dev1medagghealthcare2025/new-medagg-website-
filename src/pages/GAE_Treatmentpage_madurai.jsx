...
const GAE_Treatmentpage_madurai = () => (
  <>
    <PageMeta
      title='Genicular Artery Embolization Non Surgical Treatment With GAE in Madurai'
      description='Relieve chronic knee pain without surgery. Genicular Artery Embolization (GAE) in Madurai offers effective, non-invasive knee pain treatment. Book today!'
    />
    <Navbar />
    <Treatmentnavbar />
    <GAE_HeroSection city='Madurai' variant='madurai' />
    <GAE_Treatment_Why_Choose_us />
    <HowGAEWork />
    <GAE_Are_you_experience />
    <GAEWhySurgeries city='Madurai' variant='madurai' />
    <GAE_Bookanappoinment city='Madurai' variant='madurai' />
    ...
    <GaeFaq city='Madurai' variant='madurai' />
  </>
);

export default GAE_Treatmentpage_madurai;
