...
const VaricoseVeinDelhi = () => {
  return (
    <div className='bg-white'>
      <PageMeta
        title='No-Surgery Varicose Veins Treatment in Delhi | Endovenous Ablation'
        description='Advanced non-surgical varicose veins treatment in Delhi. Consult interventional radiology specialists for minimally invasive vein-preserving care.'
      />
      <Navbar />
      <Treatmentnavbar />
      <VaricoseVeinHeroSection city='Delhi' variant='delhi' />
      <WhyChooseEndovenousAblation />
      <VaricoseVeinWork />
      <AreYouExperiencingVaricocele />
      <VvWhySurgeries city='Delhi' variant='delhi' />
      <VV_BookAnAppointment city='Delhi' variant='delhi' />
      ...
      <VvFaq city='Delhi' variant='delhi' />
    </div>
  );
};

export default VaricoseVeinDelhi;
