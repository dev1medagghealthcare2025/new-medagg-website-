...
const Thyroid_Nodule_Ablation_Treatmentpage_coimbatore = () => (
  <>
    <PageMeta
      title='Thyroid Nodule Ablation Non Surgical Treatment in Coimbatore'
      description='Effective non-surgical thyroid nodule treatment in Coimbatore. Minimally invasive ablation procedure with quick recovery. Book today!'
    />
    <Navbar />
    <Treatmentnavbar />
    <ThyroidHerosection city='Coimbatore' variant='coimbatore' />
    <WhyChooseThyroid />
    <HowThyroidWork />
    <ThyroidWhySurgeries city='Coimbatore' variant='coimbatore' />
    <ThyroidBookAppointment city='Coimbatore' variant='coimbatore' />
    ...
    <ThyroidFaq city='Coimbatore' variant='coimbatore' />
  </>
);

export default Thyroid_Nodule_Ablation_Treatmentpage_coimbatore;
