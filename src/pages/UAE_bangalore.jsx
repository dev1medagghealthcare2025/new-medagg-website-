...
const UAE_bangalore = () => {
  return (
    <>
      <PageMeta
        title='No-Surgery Uterine Fibroid Treatment in Bangalore | Uterine Artery Embolization (UAE)'
        description='Advanced non-surgical uterine fibroid treatment in Bangalore with Uterine Artery Embolization (UAE). Consult IR specialists for uterus-preserving care.'
      />
      <Navbar />
      <Treatmentnavbar />
      <UAE_Herosection city='Bangalore' variant='bangalore' />
      <WhyChooseUAE />
      <HowUAEWorks />
      <AreYouExperiencingUAE />
      <UAEWhySurgeries city='Bangalore' variant='bangalore' />
      <ThinkYouMightNeedUAE city='Bangalore' variant='bangalore' />
      <UAE_Compare />
      <WhatHappenUAE
      ...
      <UaeFaq city='Bangalore' variant='bangalore' />
    </>
  );
};

export default UAE_bangalore;
