...
const UAE_chennai = () => {
  return (
    <>
      <PageMeta
        title='No-Surgery Uterine Fibroid Treatment in Chennai | Uterine Artery Embolization (UAE)'
        description='Advanced non-surgical uterine fibroid treatment in Chennai with Uterine Artery Embolization (UAE). Consult IR specialists for uterus-preserving care.'
      />
      <Navbar />
      <Treatmentnavbar />
      <UAE_Herosection city='Chennai' variant='chennai' />
      <WhyChooseUAE />
      <HowUAEWorks />
      <AreYouExperiencingUAE />
      <UAEWhySurgeries city='Chennai' variant='chennai' />
      <ThinkYouMightNeedUAE city='Chennai' variant='chennai' />
      <UAE_Compare />
      <WhatHappenUAE
      ...
      <UaeFaq city='Chennai' variant='chennai' />
    </>
  );
};

export default UAE_chennai;
