...
const PAE_Treatmentpage_chennai = () => (
  <>
    <PageMeta
    ...
    <Navbar />
    <Treatmentnavbar />
    <PAE_HeroSection city='Chennai' variant='chennai' />
    <PAE_Treatment_Why_Choose_Us />
    <PAE_Treatment_Procedure />
    <PAE_Treatment_FAQs />
    <PAEWhySurgeries city='Chennai' variant='chennai' />
    <PAE_Treatment_Testimonials city='Chennai' variant='chennai' />
    ...
    <PaeFaq city='Chennai' variant='chennai' />
  </>
);

export default PAE_Treatmentpage_chennai;
