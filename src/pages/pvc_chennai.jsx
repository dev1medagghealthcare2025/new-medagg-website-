...
const PVCChennai = () => {
  return (
    <div className='bg-white'>
      <PageMeta
        title='Pelvic Vein Embolization in Chennai | Minimally Invasive Relief for Chronic Pelvic Pain'
        description='Advanced non-surgical Pelvic Vein Embolization treatment in Chennai. Minimally invasive relief for chronic pelvic pain caused by pelvic venous congestion.'
      />
      <Navbar />
      <Treatmentnavbar />
      <PVCHeroSection city='Chennai' variant='chennai' />
      <PVCWhyChooseNoSurgeries />
      <PVCHowItWorks />
      <PVCAreYouExperiencing />
      <PVCWhyChooseMedagg city='Chennai' variant='chennai' />
      <PVCBookAppointment city='Chennai' variant='chennai' />
      <PVCCompare />
      <OurDoctor />
      <OurTestimonial />
