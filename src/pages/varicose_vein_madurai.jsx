...
const VaricoseVeinMadurai = () => {
  return (
    <div className='bg-white'>
      <PageMeta
        title='No-Surgery Varicose Veins Treatment in Madurai | Endovenous Ablation'
        description='Advanced non-surgical varicose veins treatment in Madurai. Consult interventional radiology specialists for minimally invasive vein-preserving care.'
      />
      <Navbar />
      <Treatmentnavbar />
      <VaricoseVeinHeroSection city='Madurai' variant='madurai' />
      <WhyChooseEndovenousAblation />
      <VaricoseVeinWork />
      <AreYouExperiencingVaricocele />
      <VvWhySurgeries city='Madurai' variant='madurai' />
      <VV_BookAnAppointment city='Madurai' variant='madurai' />
      ...
      <VvFaq city='Madurai' variant='madurai' />
    </div>
  );
};

export default VaricoseVeinMadurai;
