...
const VaricoseVeinChennai = () => {
  return (
    <div className='bg-white'>
      <PageMeta
        title='No-Surgery Varicose Veins Treatment in Chennai | Endovenous Ablation'
        description='Advanced non-surgical varicose veins treatment in Chennai. Consult interventional radiology specialists for minimally invasive vein-preserving care.'
      />
      <Navbar />
      <Treatmentnavbar />
      <VaricoseVeinHeroSection city='Chennai' variant='chennai' />
      <WhyChooseEndovenousAblation />
      <VaricoseVeinWork />
      <AreYouExperiencingVaricocele />
      <VvWhySurgeries city='Chennai' variant='chennai' />
      <VV_BookAnAppointment city='Chennai' variant='chennai' />
      ...
      <VvFaq city='Chennai' variant='chennai' />
    </div>
  );
};

export default VaricoseVeinChennai;
