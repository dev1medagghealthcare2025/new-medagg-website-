...
const Thyroid_Nodule_Ablation_Treatmentpage_bangalore = () => (
  <>
    <PageMeta
      title='Thyroid Nodule Ablation Non Surgical Treatment in Bangalore'
      description='Effective non-surgical thyroid nodule treatment in Bangalore. Minimally invasive ablation procedure with quick recovery. Book today!'
    />
    <Navbar />
    <Treatmentnavbar />
    <ThyroidHerosection city='Bangalore' variant='bangalore' />
    <WhyChooseThyroid city='Bangalore' variant='bangalore' />
    <HowThyroidWork />
    <ThyroidWhySurgeries city='Bangalore' variant='bangalore' />
    <ThyroidBookAppointment city='Bangalore' variant='bangalore' />
    ...
    <ThyroidFaq city='Bangalore' variant='bangalore' />
  </>
);

export default Thyroid_Nodule_Ablation_Treatmentpage_bangalore;
