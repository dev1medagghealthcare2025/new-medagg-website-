...
const PAE_Treatmentpage_madurai = () => (
  <>
    <PageMeta
      title='Prostate Artery Embolization Non Surgical Treatment With PAE in Madurai'
      description='Effective BPH relief with Prostate Artery Embolization (PAE) in Madurai. A non-surgical, painless treatment for enlarged prostate. Book today!'
    />
    <Navbar />
    <Treatmentnavbar />
    <PAE_HeroSection city='Madurai' variant='madurai' />
    <PAE_Treatment_Why_Choose_Us />
    <PAE_Treatment_Procedure />
    <PAE_Treatment_FAQs />
    <PAEWhySurgeries city='Madurai' variant='madurai' />
    <PAE_Treatment_Testimonials city='Madurai' variant='madurai' />
    ...
    <PaeFaq city='Madurai' variant='madurai' />
  </>
);

export default PAE_Treatmentpage_madurai;
