...
const PAE_Treatmentpage_bangalore = () => (
  <>
    <PageMeta
      title='Prostate Artery Embolization Non Surgical Treatment With PAE in Bangalore'
      description='Effective BPH relief with Prostate Artery Embolization (PAE) in Bangalore. A non-surgical, painless treatment for enlarged prostate. Book today!'
    />
    <Navbar />
    <Treatmentnavbar />
    <PAE_HeroSection city='Bangalore' variant='bangalore' />
    <PAE_Treatment_Why_Choose_Us />
    <PAE_Treatment_Procedure />
    <PAE_Treatment_FAQs />
    <PAEWhySurgeries city='Bangalore' variant='bangalore' />
    <PAE_Treatment_Testimonials city='Bangalore' variant='bangalore' />
    ...
    <PaeFaq city='Bangalore' variant='bangalore' />
  </>
);

export default PAE_Treatmentpage_bangalore;
