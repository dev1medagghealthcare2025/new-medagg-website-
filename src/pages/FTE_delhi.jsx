...
const FTE_delhi = () => (
  <>
    <PageMeta
      title='Fallopian Tube Recanalization (FTR) Treatment in Delhi | NoSurgeries'
      description='Advanced non-surgical Fallopian Tube Recanalization (FTR) in Delhi by Interventional Radiology specialists. Book a consultation with NoSurgeries by Medagg.'
    />
    <Navbar />
    <Treatmentnavbar />
    <FTE_HeroSection city='Delhi' variant='delhi' />
    <WhyChooseFTE />
    <HowFTEWork />
    <AreYouExperienceFTE />
    <FTEWhySurgeries city='Delhi' variant='delhi' />
    <BookAppointmentFTE city='Delhi' variant='delhi' />
    ...
    <FtrFaq city='Delhi' variant='delhi' />
  </>
);

export default FTE_delhi;
