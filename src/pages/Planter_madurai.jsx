...
const Planter_madurai = () => {
  return (
    <>
      <PageMeta
        title='Plantar Fasciitis Treatment in Madurai | Non-Surgical Heel Pain Relief'
        description='Get advanced non-surgical Plantar Fasciitis treatment in Madurai. Plantar Fascial Embolization (PFE) by Interventional Radiology specialists for chronic heel pain relief.'
      />
      <Navbar />
      <Treatmentnavbar />
      <PlanterHeroSection city='Madurai' variant='madurai' />
      <WhyChoosePlantar />
      <HowPlantarWork />
      <AreYouExperiencingPlanter />
      <PlanterWhySurgeries city='Madurai' variant='madurai' />
      <BookappoinmentPlanter city='Madurai' variant='madurai' />
      <CompareTreatmentPlanter />
      {/* <WhatHappensInPlantar /> */}
      <OurDoctor />
      <OurTestimonial/>
      <Consultourdoctor city='Madurai' variant='madurai' />
      <PlantarFaq city='Madurai' variant='madurai' />
    </>
  );
};

export default Planter_madurai;
