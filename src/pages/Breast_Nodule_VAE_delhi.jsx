...
const BreastNoduleVAEDelhi = () => {
  return (
    <div className='bg-white'>
      <PageMeta
        title='Breast Nodule Treatment in Delhi | Vacuum Assisted Excision (VAE)'
        description='Scar-free Vacuum Assisted Excision (VAE) for benign breast lumps in Delhi. Consult experts and get minimally invasive breast nodule treatment.'
      />
      <Navbar />
      <Treatmentnavbar />
      <BreastNoduleVAEHeroSection city='Delhi' variant='delhi' />
      <WhyChooseVAE />
      <HowVAEWorks />
      <AreYouExperiencingVAE />
      <BreastNoduleWhySurgeries city='Delhi' variant='delhi' />
      <BookAnAppointmentVAE city='Delhi' variant='delhi' />
      <CompareTreatmentVAE />
      ...
      <BreastNoduleFaq city='Delhi' variant='delhi' />
    </div>
  );
};

export default BreastNoduleVAEDelhi;
