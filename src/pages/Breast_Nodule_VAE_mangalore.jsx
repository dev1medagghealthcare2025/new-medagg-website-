...
const BreastNoduleVAEMangalore = () => {
  return (
    <div className='bg-white'>
      <PageMeta
        title='Breast Nodule Treatment in Mangalore | Vacuum Assisted Excision (VAE)'
        description='Scar-free Vacuum Assisted Excision (VAE) for benign breast lumps in Mangalore. Consult experts and get minimally invasive breast nodule treatment.'
      />
      <Navbar />
      <Treatmentnavbar />
      <BreastNoduleVAEHeroSection city='Mangalore' variant='mangalore' />
      <WhyChooseVAE />
      <HowVAEWorks />
      <AreYouExperiencingVAE />
      <BreastNoduleWhySurgeries city='Mangalore' variant='mangalore' />
      <BookAnAppointmentVAE city='Mangalore' variant='mangalore' />
      <CompareTreatmentVAE />
      ...
      <BreastNoduleFaq city='Mangalore' variant='mangalore' />
    </div>
  );
};

export default BreastNoduleVAEMangalore;
