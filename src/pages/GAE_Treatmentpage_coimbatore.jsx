...
const GAE_Treatmentpage_coimbatore = () => (
  <>
    <PageMeta
      title='Genicular Artery Embolization Non Surgical Treatment With GAE in Coimbatore'
      description='Relieve chronic knee pain without surgery. Genicular Artery Embolization (GAE) in Coimbatore offers effective, non-invasive knee pain treatment. Book today!'
    />
    <Navbar />
    <Treatmentnavbar />
    <GAE_HeroSection city='Coimbatore' variant='coimbatore' />
    <GAE_Treatment_Why_Choose_us />
    <HowGAEWork />
    <GAE_Are_you_experience />
    <GAEWhySurgeries city='Coimbatore' variant='coimbatore' />
    <GAE_Bookanappoinment city='Coimbatore' variant='coimbatore' />
    ...
    <GaeFaq city='Coimbatore' variant='coimbatore' />
  </>
);

export default GAE_Treatmentpage_coimbatore;
