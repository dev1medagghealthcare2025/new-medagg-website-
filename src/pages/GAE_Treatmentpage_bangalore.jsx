...
const GAE_Treatmentpage_bangalore = () => (
  <>
    <PageMeta
      title='Genicular Artery Embolization Non Surgical Treatment With GAE in Bangalore'
      description='Relieve chronic knee pain without surgery. Genicular Artery Embolization (GAE) in Bangalore offers effective, non-invasive knee pain treatment. Book today!'
    />
    <Navbar />
    <Treatmentnavbar />
    <GAE_HeroSection city='Bangalore' variant='bangalore' />
    <GAE_Treatment_Why_Choose_us />
    <HowGAEWork />
    <GAE_Are_you_experience />
    <GAEWhySurgeries city='Bangalore' variant='bangalore' />
    <GAE_Bookanappoinment city='Bangalore' variant='bangalore' />
    ...
    <GaeFaq city='Bangalore' variant='bangalore' />
  </>
);

export default GAE_Treatmentpage_bangalore;
