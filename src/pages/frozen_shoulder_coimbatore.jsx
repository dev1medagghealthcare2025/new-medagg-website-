...
const FrozenShoulderCoimbatore = () => {
  return (
    <>
      <PageMeta
        title='Frozen Shoulder Treatment in Coimbatore | Non-Surgical ACE'
        description='Get advanced non-surgical Frozen Shoulder treatment in Coimbatore. Adhesive Capsulitis Embolization (ACE) by Interventional Radiology specialists at MEDAGG.'
      />
      <Navbar />
      <Treatmentnavbar />
      <FrozenShoulderHero city='Coimbatore' variant='coimbatore' />
      <WhyChooseFrozenShoulder />
      <HowWorkFrozen />
      <AreYouExperiencingFrozen />
      <FrozenShoulderWhySurgeries city='Coimbatore' variant='coimbatore' />
      <BookAppointmentFrozen city='Coimbatore' variant='coimbatore' />
      <CompareFrozen />
      <OurDoctor />
      <OurTestimonial />
      <ConsultOurDoctor city='Coimbatore' variant='coimbatore' />
      <FrozenFaq city='Coimbatore' variant='coimbatore' />
    </>
  );
};

export default FrozenShoulderCoimbatore;
