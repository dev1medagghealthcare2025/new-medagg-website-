...
const MobileHeroSlide1 = ({ query, setQuery, handleSearch, results = [], isLoading = false }) => {

  return (
    <div
      className='relative w-full min-h-[88vh] sm:min-h-[88vh] bg-cover bg-center overflow-x-hidden'
      style={{
