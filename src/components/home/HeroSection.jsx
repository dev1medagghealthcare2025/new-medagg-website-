  ...
  <section
    ...
    style={{
      backgroundImage: showIndependenceDayTheme
        ? 'url(\'/independence_day_bg.png\')'
        : 'url(\'/independence_day_bg.jpg\')',
    }}
  >
    ...
    <div className='block md:absolute md:right-0 lg:right-0 md:translate-x-3 lg:translate-x-4 2xl:translate-x-5 bottom-0 z-10 w-full md:w-[380px] lg:w-[480px] xl:w-[560px] 2xl:w-[680px] md:max-h-[85vh] mt-8 md:mt-0 relative'>
      ...
      <div className='hidden md:flex absolute -top-20 right-72 flex-col items-start gap-2 z-20'>
        <p className={showIndependenceDayTheme ? 'text-[#1a1446]/80 font-bold text-sm mb-1' : 'text-white/80 font-semibold text-sm mb-1'}>Follow Us On :</p>
        <div className='flex items-center gap-3'>
          <a href='https://www.facebook.com/profile.php?id=61558841344582' target='_blank' rel='noopener noreferrer' aria-label='Facebook'
            className={showIndependenceDayTheme ? 'inline-flex h-9 w-9 items-center justify-center rounded-full border border-[#1a1446]/20 text-[#1a1446] hover:bg-[#1a1446]/10 transition-all duration-200' : 'inline-flex h-9 w-9 items-center justify-center rounded-full border border-white/30 text-white hover:bg-white/20 transition-all duration-200'}>
    ...
    <div className='relative z-10 flex flex-col justify-center items-center md:items-start w-full text-center md:text-left pt-6 pb-5 md:pt-6 md:pb-12'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full'>
        ...
        <div className={`flex flex-col justify-center items-center md:items-start h-full gap-2 sm:gap-3 w-full md:max-w-2xl lg:max-w-xl xl:max-w-2xl ${showIndependenceDayTheme ? 'pt-12 sm:pt-14 md:pt-16' : 'pt-2 sm:pt-4 md:pt-0'}`}>
          ...
          >
            {showIndependenceDayTheme ? (
              <>
                <span className='block'>Freedom to Live.</span>
                <span className='block mt-0.5 sm:mt-1'>Freedom from Pain.</span>
              </>
            ) : (
              <>
          ...
          {/* Tri-color line below heading */}
          {showIndependenceDayTheme && (
            <div className='w-24 h-1 bg-gradient-to-r from-[#FF9933] via-gray-200 to-[#128807] rounded-full mt-2 mb-4' />
          )}
          ...
          {Array.from({ length: totalSlides }).map((_, index) => (
            <button
              ...
              className={`w-3 h-3 rounded-full transition-all duration-300 ${currentSlide === index
                ? (showIndependenceDayTheme && currentSlide === 0 ? 'bg-[#1a1446] scale-125' : 'bg-white scale-125')
                : (showIndependenceDayTheme && currentSlide === 0 ? 'bg-[#1a1446]/30 hover:bg-[#1a1446]/50' : 'bg-white/50 hover:bg-white/75')
                }`}
