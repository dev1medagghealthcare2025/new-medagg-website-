...
const faqData = [
  {
    id: 1,
    question: 'How is CTO diagnosed?',
    answer: 'CTO is usually caused by the buildup of fatty deposits  in the coronary arteries, which can lead to the artery becoming completely blocked over time.',
    isOpen: true,
  },
  {
    id: 2,
    question: 'How is CTO diagnosed?',
    answer: 'CTO is often diagnosed through imaging tests such as angiography, CT angiography, or sometimes through stress tests.',
  },
  {
    id: 3,
    question: 'Is CTO a life-threatening condition?',
    answer: 'RFA has an 80-90% success rate for many arrhythmias.',
  },
  {
    id: 4,
    question: 'What is the success rate of CTO interventions?',
    answer: 'The success rate of treating CTO varies based on the complexity of the blockage. In many cases, PCI can successfully reopen the artery with good outcomes, although the long-term success rate may be little lower for complex CTOs.',
    isOpen: true,
  },
  {
    id: 5,
    question: 'How long does recovery take after a CTO procedure?',
    answer: 'Recovery from a minimally invasive CTO procedure usually takes a few days to a week, depending on the complexity. Most patients will return to normal activities within a short time.',
    isOpen: true,
  },
  {
    id: 6,
    question: 'Can CTO be prevented?',
    answer: 'While it may not always be preventable, managing risk factors such as high cholesterol, high blood pressure, diabetes, smoking, and maintaining a healthy lifestyle can reduce the likelihood of developing CTO.',
    isOpen: true,
  },
 
];

const CtoFaq = ({ city = '', variant = '' }) => {
          ...
          <div className='flex flex-col justify-center'>
            ...
            <div className='flex flex-col mb-6'>
              ...
              <h2 className='text-3xl md:text-4xl lg:text-5xl font-bold text-[#ff3576] mb-4'>
                {isCitySpecific ? `About Heart Specialist and Blocked Artery Treatment in ${cityName}` : 'Questions'}
              </h2>
