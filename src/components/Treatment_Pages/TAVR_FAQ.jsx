...
const faqData = [
  {
    id: 1,
    question: 'How is TAVR performed?',
    answer: 'TAVR is done using a catheter-based technique, meaning no open-heart surgery is required. A small incision is made in the groin or chest, and a catheter guides the new valve to the heart. The replacement valve is then expanded and positioned inside the diseased aortic valve.',
    isOpen: true,
  },
  {
    id: 2,
    question: 'How long does the procedure take?',
    answer: 'The TAVR procedure typically takes about 1 to 2 hours, and most patients stay in the hospital for 2-3 days before discharge.The TAVR procedure typically takes about 1 to 2 hours, and most patients stay in the hospital for 2-3 days before discharge.',
  },
  {
    id: 3,
    question: 'What is the recovery time after TAVR?',
    answer: 'Most patients experience significant improvement within a few days and can resume normal activities within 1-2 weeks. Full recovery varies based on individual health conditions.',
  },
  {
    id: 4,
    question: 'How long does a TAVR valve last?',
    answer: 'The durability of a TAVR valve is estimated to be 8-12 years. Regular follow-ups with a cardiologist are necessary to monitor valve function.',
    isOpen: true,
  },
  {
    id: 5,
    question: 'Will I need blood thinners after TAVR?',
    answer: 'Yes, most patients are prescribed antiplatelet or blood-thinning medications to prevent clot formation. The duration and type of medication depend on individual health conditions.',
    isOpen: true,
  },
];
