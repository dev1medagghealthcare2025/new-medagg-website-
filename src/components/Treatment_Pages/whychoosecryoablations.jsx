      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-left">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#2d2552]">
            Why Choose <span className="text-[#ff3576]">Cryoablation?</span>
          </h2>
          <p className="mt-4 max-w-3xl text-lg text-gray-600">
            Cryoablation is a minimally invasive treatment that uses extreme cold to freeze and destroy benign breast nodules, offering a non-surgical alternative with minimal scarring and quick recovery.
          </p>
        </div>
