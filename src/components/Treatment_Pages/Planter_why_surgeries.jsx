          ...
          <div>
            ...
            <div className='mt-6 rounded-xl border border-[#ff3576]/30 bg-white px-5 py-4'>
              <p className='text-gray-700'>
                <span className='font-semibold text-[#ff3576]'>Plantar Fasciitis:</span> No surgeries for chronic heel pain using Plantar Fasciitis Embolization, a minimally invasive treatment that reduces inflammation and relieves pain.
              </p>
            </div>
...
export default PlanterWhySurgeries;
