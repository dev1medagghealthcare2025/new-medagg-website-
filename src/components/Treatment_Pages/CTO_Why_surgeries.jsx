...
const CTOWhySurgeries = ({ city = '', variant = '' }) => {
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-start'>
          <div>
            ...
            <h2 className='text-4xl sm:text-5xl font-extrabold text-[#2d2552] leading-tight'>
              {isCitySpecific
                ? `In ${cityName}, No-Surgery Treatment for Blocked Artery is Available`
            ...
            <div className='mt-6 rounded-xl border border-[#ff3576]/30 bg-white px-5 py-4'>
              <p className='text-gray-700'>
                <span className='font-semibold text-[#ff3576]'>Chronic Total Occlusion (CTO):</span> No surgeries for chronic total arterial blockages using balloon angioplasty and stenting, restoring blood flow and reducing symptoms.
...
export default CTOWhySurgeries;
