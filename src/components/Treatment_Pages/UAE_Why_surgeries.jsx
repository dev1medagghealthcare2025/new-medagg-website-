        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-start'>
          <div>
            ...
            <div className='mt-6 rounded-xl border border-[#ff3576]/30 bg-white px-5 py-4'>
              <p className='text-gray-700'>
                <span className='font-semibold text-[#ff3576]'>Uterine Fibroids:</span> No surgeries for uterine
                fibroids through Fibroid Embolization, a minimally invasive
              </p>
            </div>
            ...
            <div className='mt-6'>
              <Link
                to='/#services'
                className='inline-flex items-center justify-center rounded-full bg-[#ff3576] px-6 py-3 text-white font-semibold shadow-sm hover:bg-[#e82d69] transition-colors'
              >
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
            {features.map((item) => (
              <div
                key={item.id}
                className='bg-white rounded-2xl border border-gray-100 shadow-md p-5 flex items-center gap-4 transform-gpu transition-all duration-300 ease-out hover:-translate-y-1 hover:scale-[1.02] hover:shadow-xl active:scale-[0.98]'
              >
