          ...
          <div>
            ...
            <div className='mt-6 rounded-xl border border-[#ff3576]/30 bg-white px-5 py-4'>
              <p className='text-gray-700'>
                <span className='font-semibold text-[#ff3576]'>AVM (Arteriovenous Malformation):</span> No major surgeries for AVMs using Radiofrequency Ablation, precisely treating abnormal vessels while preserving surrounding tissue.
...
export default AVMWhySurgeries;
