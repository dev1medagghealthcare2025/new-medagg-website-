...
const faqData = [
  {
    id: 1,
    question: 'How is embolization different from surgery?',
    answer: 'Embolization is a minimally invasive procedure that targets the inflamed area through blood vessels - no cutting or stitches are required.',
    isOpen: true,
  },
  {
    id: 2,
    question: 'How long does the procedure take?',
    answer: 'The procedure typically takes about an hour to complete.',
  },
  {
    id: 3,
    question: 'Is embolization a cure for plantar fasciitis?',
    answer: 'It provides long-term relief from pain and inflammation, addressing the root cause of the issue.',
  },
  {
    id: 4,
    question: 'What are the side effects of embolization?',
    answer: 'Side effects are generally mild and may include temporary bruising or discomfort at the injection site.',
    isOpen: true,
  },
  {
    id: 5,
    question: 'How soon can I return to normal activities?',
    answer: ' Most patients can resume normal activities within a few days to two weeks after the procedure.',
    isOpen: true,
  },
];

const PlantarFaq = ({ city = '', variant = '' }) => {
              ...
              {isCitySpecific ? (
                <>
                  ...
                  <h2 className='text-3xl md:text-4xl lg:text-5xl font-bold text-[#2d2552] mb-4'>
                    About <span className='text-[#ff3576]'>Plantar Fasciitis</span>
                    <br />
