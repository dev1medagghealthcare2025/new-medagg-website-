...
const DiabeticFootWhySurgeries = ({ city = '', variant = '' }) => {
          ...
          <div>
            ...
            {isCitySpecific ? (
              <h2 className='text-4xl sm:text-5xl font-extrabold text-[#2d2552] leading-tight'>
                In {cityName}, No-Surgery Treatment
                <br />
                Available for Diabetic Foot
              </h2>
            ) : (
              <h2 className='text-4xl sm:text-5xl font-extrabold text-[#2d2552] leading-tight'>
                Surgery Isn’t
            ...
            <div className='mt-6 rounded-xl border border-[#ff3576]/30 bg-white px-5 py-4'>
              <p className='text-gray-700'>
                <span className='font-semibold text-[#ff3576]'>Diabetic Foot:</span> No surgeries for diabetic foot complications through endovascular recanalization and stenting, improving blood flow and aiding wound healing.
...
export default DiabeticFootWhySurgeries;
