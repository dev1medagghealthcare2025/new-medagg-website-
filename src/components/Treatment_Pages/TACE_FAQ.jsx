...
const faqData = [
  {
    ...
    answer: 'No. TACE is a minimally invasive, catheter-based procedure and does not involve open surgery.',
    isOpen: true,
  },
  {
    id: 2,
    question: 'How long will I need to stay in the hospital?',
    answer: 'Most patients stay in the hospital for observation for a short period, depending on recovery and medical advice.',
  },
  {
    id: 3,
    question: 'Is the procedure painful?',
    answer: 'The procedure is performed with medications for comfort. Some patients may experience temporary pain or fever afterward, which is managed medically.',
  },
  {
    id: 4,
    question: 'How is eligibility decided for this treatment?',
    answer: 'Doctors assess imaging, liver function, tumor size, and location before recommending TACE.',
    isOpen: true,
  },
  {
    id: 5,
    question: 'Can this treatment be combined with other therapies?',
    answer: 'TACE may be combined with other treatments as part of a planned cancer care approach, based on individual needs.',
    isOpen: true,
  },
  {
    id: 6,
    question: 'What should I expect after the procedure?',
    answer: 'Follow-up imaging and blood tests help assess tumor response and guide further care.',
    isOpen: true,
  },
  {
    id: 7,
    question: 'Will I experience side effects like regular chemotherapy?',
    answer: 'Because chemotherapy is delivered directly to the tumor, whole-body side effects are generally less than with intravenous chemotherapy.',
    isOpen: true,
  },
];
          ...
          <div className='flex flex-col justify-center'>
            ...
            <div className='flex flex-col mb-6'>
              ...
              <h2 className='text-3xl md:text-4xl lg:text-5xl font-bold text-[#ff3576] mb-4'>
                {isCitySpecific ? `About TACE Treatment in ${cityName}` : 'Questions'}
              </h2>
