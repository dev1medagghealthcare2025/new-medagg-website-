          ...
          <div>
            ...
            <div className='mt-6 rounded-xl border border-[#ff3576]/30 bg-white px-5 py-4'>
              <p className='text-gray-700'>
                <span className='font-semibold text-[#ff3576]'>Varicose Veins:</span> No surgeries for varicose veins using minimally invasive vein treatments that reduce pain, swelling, and recovery time.
              </p>
            </div>
