...
const faqData = [
  {
    ...
    answer: 'No. Y-90 Radioembolization is a minimally invasive procedure performed through blood vessels, without open surgery or large incisions.',
    isOpen: true,
  },
  {
    id: 2,
    question: 'How long will I need to stay in the hospital?',
    answer: 'Most patients require a short hospital stay for monitoring. The exact duration depends on individual recovery and medical advice',
  },
  {
    id: 3,
    question: 'Is the procedure painful?',
    answer: 'The procedure is done under medication to ensure comfort. Some patients may experience mild discomfort or fatigue afterward, which is usually temporary.',
  },
  {
    id: 4,
    question: 'How is eligibility decided for this treatment?',
    answer: 'Eligibility is based on imaging, liver function, tumor characteristics, and overall health. A specialist team reviews all reports before recommending treatment.',
    isOpen: true,
  },
  {
    id: 5,
    question: 'Can this treatment be combined with other therapies?',
    answer: 'In some cases, Y-90 may be part of a broader treatment plan. This is decided by the treating medical team.',
    isOpen: true,
  },
  {
    id: 6,
    question: 'What should I expect after the procedure?',
    answer: 'Follow-up scans and consultations are scheduled to monitor response. Recovery experiences vary from patient to patient.',
    isOpen: true,
  },
  {
    id: 7,
    question: 'Will the radiation affect people around me?',
    answer: 'The radiation is targeted and carefully controlled. Safety guidelines are provided to minimize any risk to others.',
    isOpen: true,
  },
];

const ThyroidFaq = ({ city = '', variant = '' }) => {
          ...
          <div className='flex flex-col justify-center'>
            ...
            <div className='flex flex-col mb-6'>
              ...
              <h2 className='text-3xl md:text-4xl lg:text-5xl font-bold text-[#ff3576] mb-4'>
                {isCitySpecific ? `About Y-90 (TARE) Treatment in ${cityName}` : 'Questions'}
              </h2>
