      ...
      const response = await fetch('https://api.telecrm.in/enterprise/658abddbf911ed2d692b0cf5/autoupdatelead', {
        ...
        body: JSON.stringify({
          fields: {
            ...
            source: 'Website - Nuclear Medicine Book Appointment Form',
          },
        }),
      });
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            <div className='text-white space-y-6 text-center lg:text-left'>
              <h2 className='text-3xl md:text-4xl font-bold leading-tight'>
                ...
                <br />
                <span className='text-[#ff3576]'>Chronic Synovitis?</span>
              </h2>
              <p className='text-lg text-gray-200 max-w-lg mx-auto lg:mx-0 mb-2'>
                If you are experiencing persistent joint inflammation, swelling, or pain, consult our
                specialists to determine whether radiosynovectomy may be an appropriate treatment option.
              </p>
              <Link to='/contact-us' className='inline-block mt-6'>
                <button
                  type='button'
                  className='bg-[#ff3576] text-white px-8 py-3 rounded-lg font-semibold hover:bg-pink-700 transition-colors duration-300 text-lg'
                >
                  Book Appointment
                </button>
              </Link>
            ...
            <div className='flex justify-center lg:justify-end'>
              <div className='bg-white rounded-2xl p-8 shadow-lg w-full max-w-md'>
                <h3 className='text-2xl font-bold text-[#2d2552] mb-6'>Get Expert Consultation</h3>
...
export default BookAppoinmentNuclear;
