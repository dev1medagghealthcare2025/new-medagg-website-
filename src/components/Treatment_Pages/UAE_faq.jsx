...
const faqData = [
  {
    id: 1,
    question: 'How does UAE differ from surgery?',
    answer: 'UAE is a minimally invasive procedure that does not need the removal of the uterus (hysterectomy). While surgery includes physically removing fibroids or the entire uterus, UAE does not remove the uterus.',
    isOpen: true,
  },
  {
    id: 2,
    question: 'Who would be a good candidate for the UAE?',
    answer: ' UAE may be a good option for women with symptomatic uterine fibroids who want to keep their uterus intact, do not want surgery, or are worried about the length of recuperation required for conventional surgical procedures.',
  },
  {
    id: 3,
    question: 'Is the UAE treatment painful?',
    answer: 'Patients may feel some pain or cramping during UAE, which usually involves local anesthetic or conscious sedation. Painkillers are frequently recommended to treat discomfort following surgery.But the pain experienced is not as significant as traditional surgery.',
    
  },
  {
    id: 4,
    question: 'When may regular activities be resumed after UAE?',
    answer: 'Recovery periods differ, however many women are back to their regular routines in about a week. It could be necessary to refrain from strenuous activity for a little while longer.',
    isOpen: true,
  },
  {
    id: 5,
    question: 'Are there any other treatments for fibroids besides UAE?',
    answer: 'Surgical options including hysterectomy , myomectomy and hormone therapy are alternatives.',
    isOpen: true,
  },
  {
    id: 6,
    question: 'How successful is UAE in treating fibroids?',
    answer: 'Research has demonstrated that UAE is useful in easing the symptoms of fibroids, including severe bleeding and pelvic pain. the logn term effectiveness will vary from person to person. lifestyle changes are required.',
    isOpen: true,
  },
  {
    id: 7,
    question: 'Will fibroids come back after UAE?',
    answer: 'Although UAE effectively reduces the size and symptoms of fibroids, there is a very slight possibility that new fibroids will eventually form. It is advised to follow up on a regular basis.',
    isOpen: true,
  },
];

const UaeFaq = ({ city = '', variant = '' }) => {
