          ...
          <div>
            ...
            <div className='mt-6 rounded-xl border border-[#ff3576]/30 bg-white px-5 py-4'>
              <p className='text-gray-700'>
                <span className='font-semibold text-[#ff3576]'>Arrhythmia:</span> No open surgeries for heart rhythm disorders using Radiofrequency Ablation (RFA), helping restore normal heart rhythm safely.
              </p>
            </div>
...
export default RFAWhySurgeries;
