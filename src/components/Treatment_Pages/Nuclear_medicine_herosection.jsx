...
export default function NuclearMedicineHerosection() {
      ...
      const response = await fetch('https://api.telecrm.in/enterprise/658abddbf911ed2d692b0cf5/autoupdatelead', {
        ...
        body: JSON.stringify({
          fields: {
            ...
            source: 'Website - Nuclear Medicine Hero Section Form',
          },
        }),
      });
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: "url('/Nuclear-medicine_herobg.png')",
        backgroundSize: 'cover',
        backgroundPosition: 'center',
        minHeight: '440px',
      }}
    >
      <div className='absolute inset-0 bg-[#2d2552] opacity-60' />
      <style>{`
        ...
        .nm-form-input::-webkit-input-placeholder {
          color: white !important;
          opacity: 1 !important;
          -webkit-text-fill-color: white !important;
        }
        .nm-form-input::-moz-placeholder {
          color: white !important;
          opacity: 1 !important;
        }
        .nm-form-input {
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center'>
          <div className='text-center lg:text-left'>
            ...
            <p className='mt-4 text-sm sm:text-base lg:text-lg text-white/85 max-w-2xl mx-auto lg:mx-0'>
              A local intra-articular treatment used for managing chronic synovitis and inflammatory joint diseases.
            </p>
          </div>
              ...
              <form onSubmit={handleSubmit} className='space-y-3'>
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-3'>
                  <input
                    ...
                    placeholder='Name'
                    className='nm-form-input w-full rounded-md bg-white/15 border border-white/10 px-4 py-3 text-sm text-white focus:outline-none focus:ring-2 focus:ring-[#ff3576]'
                    required
                  />
                  <input
                    type='tel'
                ...
                <textarea
                  ...
                  className='nm-form-input w-full rounded-md bg-white/15 border border-white/10 px-4 py-3 text-sm text-white focus:outline-none focus:ring-2 focus:ring-[#ff3576] resize-none'
                  rows={4}
                  required
                />
                ...
                <button
                  ...
                  className='w-full bg-[#ff3576] hover:bg-pink-600 text-white font-semibold text-sm sm:text-base py-3 rounded-md transition-colors disabled:bg-gray-400 flex items-center justify-center gap-2'
                >
