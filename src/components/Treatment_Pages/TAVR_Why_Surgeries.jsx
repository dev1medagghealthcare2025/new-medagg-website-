          ...
          <div>
            ...
            <div className='mt-6 rounded-xl border border-[#ff3576]/30 bg-white px-5 py-4'>
              <p className='text-gray-700'>
                <span className='font-semibold text-[#ff3576]'>Aortic Valve Disease:</span> No open-heart surgeries for aortic valve disease using Transcatheter Aortic Valve Implantation (TAVI), improving heart function with faster recovery.
              </p>
            </div>
...
export default TAVRWhySurgeries;
