...
const faqData = [
  {
    id: 1,
    question: 'Who performs Adhesive Capsulitis Embolization (ACE)?',
    answer: 'Adhesive Capsulitis Embolization is an interventional radiology procedure performed by a doctor known as an Interventional Radiologist.',
    isOpen: true,
  },
  {
    id: 2,
    question: 'How is Frozen Shoulder diagnosed?',
    answer: 'A healthcare professional diagnoses frozen shoulder based on your symptoms, physical examination, and imaging tests such as X-rays or MRI, along with an assessment of shoulder movement and pain.',
  },
  {
    id: 3,
    question: 'Should I worry too much about frozen shoulder symptoms?',
    answer: 'Frozen shoulder is not a life-threatening condition, but it can cause significant pain and stiffness. If left untreated, it may severely limit shoulder movement and affect daily activities and quality of life.',
  },
  {
    id: 4,
    question: 'Is frozen shoulder related to arthritis or injury?',
    answer: 'Frozen shoulder can sometimes develop after injury, surgery, or prolonged immobility. It is different from arthritis but may share similar symptoms such as pain and stiffness.',
    isOpen: true,
  },
  {
    id: 5,
    question: 'What is the recovery time after ACE?',
    answer: 'Most patients can return to light daily activities within a few days after ACE. Recovery and improvement in shoulder movement usually occur gradually over the following weeks.',
    isOpen: true,
  },
  {
    id: 6,
    question: 'Is ACE a permanent solution for frozen shoulder?',
    answer: 'ACE can provide long-lasting relief from pain and stiffness for many patients. However, results may vary, and physiotherapy is often recommended to maintain improvement.',
    isOpen: true,
  },
  {
    id: 7,
    question: 'Who is a suitable candidate for ACE?',
    answer: 'ACE may be suitable for patients with frozen shoulder who have persistent pain and restricted movement and have not responded well to medications or physiotherapy.',
    isOpen: true,
  },
];

const FrozenFaq = ({ city = '', variant = '' }) => {
          ...
          <div className='flex flex-col justify-center'>
            ...
            <div className='flex flex-col mb-6'>
              ...
              <h2 className='text-3xl md:text-4xl lg:text-5xl font-bold text-[#ff3576] mb-4'>
                {isCitySpecific ? `About Frozen Shoulder Treatment in ${cityName}` : 'Questions'}
              </h2>
