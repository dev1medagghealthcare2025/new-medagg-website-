...
const NosurgeriesTreatmentNuclear = () => {
    ...
    <section className='bg-[#fbf7f8] py-10 md:py-16'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-start'>
          <div>
            <p className='text-base sm:text-lg font-semibold text-[#2d2552] mb-4'>
              Why Choose NoSurgeries / MEDAGG?
            </p>

            <h2 className='text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#ff3576] leading-tight'>
              No-Surgery Treatment Option Available for Chronic Joint Inflammation
            </h2>
            ...
            <div className='mt-6 rounded-xl border border-[#ff3576]/30 bg-white px-5 py-4'>
              <p className='text-gray-700 leading-relaxed'>
                <span className='font-semibold text-[#ff3576]'>No surgeries</span> for{' '}
                <span className='font-semibold text-[#ff3576]'>chronic joint inflammation</span> through{' '}
                <span className='font-semibold text-[#ff3576]'>Radiosynovectomy</span> — a minimally invasive,
                incision-free treatment that relieves pain and bleeding with faster recovery and minimal downtime.
              </p>
            </div>
          ...
          <div ref={gridRef} className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
            {features.map((item, index) => (
              <div
                ...
                className={`group relative overflow-hidden bg-white rounded-2xl border border-[#ff3576]/30 shadow-md p-5 flex items-center gap-4 transform-gpu transition-all duration-700 ease-out hover:-translate-y-1 hover:scale-[1.02] hover:shadow-xl hover:border-[#ff3576]/50 active:scale-[0.98] ${
...
export default NosurgeriesTreatmentNuclear;
