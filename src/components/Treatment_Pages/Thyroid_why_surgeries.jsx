...
const ThyroidWhySurgeries = ({ city = '', variant = '' }) => {
          ...
          <div>
            ...
            {isCitySpecific ? (
              <>
                ...
                <h2 className='text-3xl sm:text-4xl font-extrabold text-[#ff3576] leading-tight'>
                  In {isChennai ? 'Chennai' : isMadurai ? 'Madurai' : isCoimbatore ? 'Coimbatore' : isBangalore ? 'Bangalore' : 'Mangalore'}, No-Surgery Option is Available for Thyroid Nodules
                </h2>
              </>
            ) : (
            ...
            <div className='mt-6 rounded-xl border border-[#ff3576]/30 bg-white px-5 py-4'>
              <p className='text-gray-700'>
                <span className='font-semibold text-[#ff3576]'>Thyroid Nodules:</span> No surgeries for thyroid nodules with minimally invasive thyroid ablation, without scars or thyroid removal.
              </p>
            </div>
...
export default ThyroidWhySurgeries;
